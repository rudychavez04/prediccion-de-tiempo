    ...
    <div className="mt-5">
        {
            showData === true ? (
                <div className="container">
                    <div className="card mb-3 mx-auto bg-dark text-light rounded-4">
                        <div className="row g-0">
                            <div className="col-md-4">
                                ...
                                <img src="https://images.pexels.com/photos/2448749/pexels-photo-2448749.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt=".."/>
                            </div>
                            <div className="col-md-8">
                                <div className="card-body text-start mt-2">
                                    ...
                                    <div className="row mt-4">
                                        <div className="col">
                                            <p className='text-center'>{forecastDate3}h</p>
                                        ...
                                        <div className="col">
                                            <p className='text-center'>{forecastDate6}h</p>
                                            <p className="description">
                                        ...
                                        <div className="col">
                                            <p className='text-center'>{forecastDate9}h</p>
                                            <p className="description">
                                    ...
                                    {/* <p className='card-desc'><img src={iconUrl3} alt="icon" />{forecast.list[1].weather[0].description}</p>
                                    <p className='card-desc'><img src={iconUrl6} alt="icon" />{forecast.list[2].weather[0].description}</p>
                                    <p className='card-desc'><img src={iconUrl9} alt="icon" />{forecast.list[3].weather[0].description}</p> */}
